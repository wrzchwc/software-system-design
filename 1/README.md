...
###	Wymagania systemowe
1. System działa na urządzeniach z systemem operacyjnym macOS (w najnowszej wersji) oraz Windows (w najnowszej wersji) oraz przeglądarkach internetowych (Google Chrome, Safari , Microsoft Edge w najnowszej wersji)
2. System działa na urządzeniach mobilnych z systemem operacyjnym Android (w najnowszej wersji) oraz iOS (w najnowszej wersji)
